...
| background-color    | background color of Menu (hex format) (deprecated, use `--el-menu-bg-color` instead)                                                                                          | string  | —                     | #ffffff  |
| text-color          | text color of Menu (hex format) (deprecated, use `--el-menu-text-color` instead)                                                                                              | string  | —                     | #303133  |
| active-text-color   | text color of currently active menu item (hex format) (deprecated, use `--el-menu-active-color` instead)                                                                      | string  | —                     | #409EFF  |
